      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <button
            ...
            className="md:hidden p-3 rounded-lg text-gray-500 hover:bg-gray-50"
          >
          ...
          {menuOpen && (
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 pt-4 border-t border-gray-100">
                {user && <NotificationBell userId={user.id} />}
                <div className="flex items-center gap-2">
                  <div className="w-7 h-7 rounded-full bg-orange-100 flex items-center justify-center text-orange-600 font-bold text-sm">
                    {user?.name?.charAt(0)}
                  </div>
                  <span className="text-sm font-medium text-gray-700">
                    {user?.name?.split(" ")[0]}
